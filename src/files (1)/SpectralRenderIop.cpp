        ...
        if (el->skyPreset > 0) {
            ...
            if (si > 0.001) {
                ...
                if (el->sunShadowSoftness > 0.01) {
                    ...
                    // Compensate for inverse-square attenuation at distance
                    float dist2 = dist * dist;
                    sun.color = GfVec3f(float(sunR * si * dist2), float(sunG * si * dist2), float(sunB * si * dist2));
                } else {
    ...
    for (SpectralStudioLight* sl : _allStudioLights) {
        ...
        if (ki > 0.001) {
            ...
            if (sl->shadowSoftness > 0.01) {
                ...
                float dist2 = dist * dist;
                key.color = GfVec3f(float(ki * dist2), float(ki * 0.95 * dist2), float(ki * 0.9 * dist2));
            } else {
